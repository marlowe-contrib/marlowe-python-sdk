...
from openapi_client.models.contract_state import ContractState  # noqa: E501

class TestContractState(unittest.TestCase):
    """ContractState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractState:
        """Test ContractState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractState`
        """
        model = ContractState()  # noqa: E501
        if include_optional:
