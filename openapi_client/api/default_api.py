...
class DefaultApi:
    ...
    @validate_arguments
    def get_transactions_for_contract(self, contract_id : constr(strict=True), range : Optional[StrictStr] = None, **kwargs) -> GetContractsResponse:  # noqa: E501
    ...
    @validate_arguments
    def get_withdrawals(self, role_currency : Optional[conlist(constr(strict=True))] = None, range : Optional[StrictStr] = None, **kwargs) -> GetContractsResponse:  # noqa: E501
