...
class Input(BaseModel):
    ...
    # data type: str
    oneof_schema_2_validator: Optional[StrictStr] = Field(default=None, description="Notify a contract to check a condition")
    ...
    actual_instance: Optional[Union[InputOneOf, InputOneOf1, InputOneOf2, InputOneOf3, InputOneOf4, str]] = None
    one_of_schemas: List[str] = Literal["InputOneOf", "InputOneOf1", "InputOneOf2", "InputOneOf3", "InputOneOf4", "str"]
