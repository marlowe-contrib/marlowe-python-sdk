...
class ListObjectTxHeaderResultsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListObjectTxHeaderResultsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListObjectTxHeaderResultsInner:
        """Create an instance of ListObjectTxHeaderResultsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListObjectTxHeaderResultsInner.parse_obj(obj)

        _obj = ListObjectTxHeaderResultsInner.parse_obj({
