...
class PostTransactionsRequest(BaseModel):
    ...
    """ # noqa: E501
    inputs: List[Input]
    invalid_before: Optional[StrictStr] = Field(default=None, alias="invalidBefore")
    invalid_hereafter: Optional[StrictStr] = Field(default=None, alias="invalidHereafter")
    metadata: Dict[str, Any]
    tags: Dict[str, Any]
    version: MarloweVersion
    __properties: ClassVar[List[str]] = ["inputs", "invalidBefore", "invalidHereafter", "metadata", "tags", "version"]
