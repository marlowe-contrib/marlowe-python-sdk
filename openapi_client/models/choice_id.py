...
class ChoiceId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChoiceId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChoiceId:
        """Create an instance of ChoiceId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChoiceId.parse_obj(obj)

        _obj = ChoiceId.parse_obj({
            "choice_name": obj.get("choice_name"),
            "choice_owner": Party.from_dict(obj.get("choice_owner")) if obj.get("choice_owner") is not None else None
        })
        return _obj
