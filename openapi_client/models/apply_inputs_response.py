...
class ApplyInputsResponse(BaseModel):
    """
    ApplyInputsResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplyInputsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplyInputsResponse:
        """Create an instance of ApplyInputsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplyInputsResponse.parse_obj(obj)

        _obj = ApplyInputsResponse.parse_obj({
