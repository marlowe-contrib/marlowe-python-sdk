...
class CreateTxBodyEnvelope(BaseModel):
    """
    The \"type\" property of \"txBody\" must be \"TxBody BabbageEra\" or \"TxBody ConwayEra\"  # noqa: E501
    """
    ...
    tx_body: TextEnvelope = Field(..., alias="txBody")
    __properties = ["contractId", "safetyErrors", "txBody"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTxBodyEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateTxBodyEnvelope:
        """Create an instance of CreateTxBodyEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateTxBodyEnvelope.parse_obj(obj)

        _obj = CreateTxBodyEnvelope.parse_obj({
