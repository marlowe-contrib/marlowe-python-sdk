...
class GetPayoutsResponseResultsInner(BaseModel):
    """
    GetPayoutsResponseResultsInner
    """
    links: GetPayoutsResponseResultsInnerLinks = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPayoutsResponseResultsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPayoutsResponseResultsInner:
        """Create an instance of GetPayoutsResponseResultsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPayoutsResponseResultsInner.parse_obj(obj)

        _obj = GetPayoutsResponseResultsInner.parse_obj({
            "links": GetPayoutsResponseResultsInnerLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None,
