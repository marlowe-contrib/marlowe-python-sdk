...
class ContractObjectOneOf4(BaseModel):
    ...
    then: ContractObject
    __properties: ClassVar[List[str]] = ["assert", "then"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "assert": ObservationObject.from_dict(obj.get("assert")) if obj.get("assert") is not None else None,
...
ContractObjectOneOf4.model_rebuild(raise_errors=False)
