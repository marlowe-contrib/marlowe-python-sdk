...
class ContractObjectOneOf4(BaseModel):
    """
    Check an observation and produce a warning if it is false.  # noqa: E501
    """
    var_assert: ObservationObject = Field(..., alias="assert")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractObjectOneOf4:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractObjectOneOf4:
        """Create an instance of ContractObjectOneOf4 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractObjectOneOf4.parse_obj(obj)

        _obj = ContractObjectOneOf4.parse_obj({
            "var_assert": ObservationObject.from_dict(obj.get("assert")) if obj.get("assert") is not None else None,
...
ContractObjectOneOf4.update_forward_refs()
