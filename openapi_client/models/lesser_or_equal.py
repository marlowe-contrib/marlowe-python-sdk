...
class LesserOrEqual(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LesserOrEqual:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LesserOrEqual:
        """Create an instance of LesserOrEqual from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LesserOrEqual.parse_obj(obj)

        _obj = LesserOrEqual.parse_obj({
...
LesserOrEqual.update_forward_refs()
