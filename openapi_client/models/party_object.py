...
class PartyObject(BaseModel):
    ...
    actual_instance: Optional[Union[PartyOneOf, PartyOneOf1, ValueObjectOneOf8]] = None
    one_of_schemas: List[str] = Literal["PartyOneOf", "PartyOneOf1", "ValueObjectOneOf8"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PartyObject.model_construct()
        error_messages = []
        match = 0
