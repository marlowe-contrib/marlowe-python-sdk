...
class WithdrawTxBodyEnvelope(BaseModel):
    """
    ...
    __properties = ["txBody", "withdrawalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WithdrawTxBodyEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WithdrawTxBodyEnvelope:
        """Create an instance of WithdrawTxBodyEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WithdrawTxBodyEnvelope.parse_obj(obj)

        _obj = WithdrawTxBodyEnvelope.parse_obj({
