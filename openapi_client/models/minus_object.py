...
class MinusObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinusObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinusObject:
        """Create an instance of MinusObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MinusObject.parse_obj(obj)

        _obj = MinusObject.parse_obj({
...
MinusObject.update_forward_refs()
