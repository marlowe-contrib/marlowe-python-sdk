...
VALUEOBJECT_ONE_OF_SCHEMAS = ["ValueObjectOneOf", "ValueObjectOneOf1", "ValueObjectOneOf2", "ValueObjectOneOf3", "ValueObjectOneOf4", "ValueObjectOneOf5", "ValueObjectOneOf6", "ValueObjectOneOf7", "ValueObjectOneOf8", "ValueOneOf7", "int", "str"]
...
class ValueObject(BaseModel):
    ...
    oneof_schema_12_validator: Optional[ValueObjectOneOf8] = None
    actual_instance: Optional[Union[ValueObjectOneOf, ValueObjectOneOf1, ValueObjectOneOf2, ValueObjectOneOf3, ValueObjectOneOf4, ValueObjectOneOf5, ValueObjectOneOf6, ValueObjectOneOf7, ValueObjectOneOf8, ValueOneOf7, int, str]] = None
    one_of_schemas: List[str] = Literal["ValueObjectOneOf", "ValueObjectOneOf1", "ValueObjectOneOf2", "ValueObjectOneOf3", "ValueObjectOneOf4", "ValueObjectOneOf5", "ValueObjectOneOf6", "ValueObjectOneOf7", "ValueObjectOneOf8", "ValueOneOf7", "int", "str"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ValueObject.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ValueObject with oneOf schemas: ValueObjectOneOf, ValueObjectOneOf1, ValueObjectOneOf2, ValueObjectOneOf3, ValueObjectOneOf4, ValueObjectOneOf5, ValueObjectOneOf6, ValueObjectOneOf7, ValueObjectOneOf8, ValueOneOf7, int, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ValueObject with oneOf schemas: ValueObjectOneOf, ValueObjectOneOf1, ValueObjectOneOf2, ValueObjectOneOf3, ValueObjectOneOf4, ValueObjectOneOf5, ValueObjectOneOf6, ValueObjectOneOf7, ValueObjectOneOf8, ValueOneOf7, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ValueObject with oneOf schemas: ValueObjectOneOf, ValueObjectOneOf1, ValueObjectOneOf2, ValueObjectOneOf3, ValueObjectOneOf4, ValueObjectOneOf5, ValueObjectOneOf6, ValueObjectOneOf7, ValueObjectOneOf8, ValueOneOf7, int, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
...
ValueObject.model_rebuild(raise_errors=False)
