...
class ValueObject(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[ValueObjectOneOf, ValueObjectOneOf1, ValueObjectOneOf2, ValueObjectOneOf3, ValueObjectOneOf4, ValueObjectOneOf5, ValueObjectOneOf6, ValueObjectOneOf7, ValueObjectOneOf8, ValueOneOf7, int, str]
    else:
        actual_instance: Any
