...
class DepositActionObject(BaseModel):
    """
    DepositActionObject
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DepositActionObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DepositActionObject:
        """Create an instance of DepositActionObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DepositActionObject.parse_obj(obj)

        _obj = DepositActionObject.parse_obj({
