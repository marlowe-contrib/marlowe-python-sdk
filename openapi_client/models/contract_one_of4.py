...
class ContractOneOf4(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractOneOf4:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractOneOf4:
        """Create an instance of ContractOneOf4 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractOneOf4.parse_obj(obj)

        _obj = ContractOneOf4.parse_obj({
...
ContractOneOf4.update_forward_refs()
