...
class ObservationObjectOneOf8(BaseModel):
    """
    ObservationObjectOneOf8
    """
    equal_to: ValueObject = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObservationObjectOneOf8:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObservationObjectOneOf8:
        """Create an instance of ObservationObjectOneOf8 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObservationObjectOneOf8.parse_obj(obj)

        _obj = ObservationObjectOneOf8.parse_obj({
            "equal_to": ValueObject.from_dict(obj.get("equal_to")) if obj.get("equal_to") is not None else None,
...
ObservationObjectOneOf8.update_forward_refs()
