...
class WithdrawalsPost201Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WithdrawalsPost201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WithdrawalsPost201Response:
        """Create an instance of WithdrawalsPost201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WithdrawalsPost201Response.parse_obj(obj)

        _obj = WithdrawalsPost201Response.parse_obj({
