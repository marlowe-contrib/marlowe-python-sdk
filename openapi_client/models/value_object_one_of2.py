...
class ValueObjectOneOf2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["add", "and"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "and": ValueObject.from_dict(obj.get("and")) if obj.get("and") is not None else None
        })
        return _obj

from openapi_client.models.value_object import ValueObject
# TODO: Rewrite to not use raise_errors
ValueObjectOneOf2.model_rebuild(raise_errors=False)
