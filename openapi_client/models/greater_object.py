...
class GreaterObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GreaterObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GreaterObject:
        """Create an instance of GreaterObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GreaterObject.parse_obj(obj)

        _obj = GreaterObject.parse_obj({
...
GreaterObject.update_forward_refs()
