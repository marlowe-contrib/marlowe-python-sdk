...
class Case(BaseModel):
    ...
    actual_instance: Optional[Union[CaseOneOf, CaseOneOf1]] = None
    one_of_schemas: List[str] = Literal["CaseOneOf", "CaseOneOf1"]
...
Case.model_rebuild(raise_errors=False)
