...
class GetTransactionsResponse(BaseModel):
    ...
    """
    results: conlist(GetTransactionsResponseResultsInner) = Field(...)
    ...
    def from_dict(cls, obj: dict) -> GetTransactionsResponse:
        ...
        _obj = GetTransactionsResponse.parse_obj({
            "results": [GetTransactionsResponseResultsInner.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
