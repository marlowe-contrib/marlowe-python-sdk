...
class Multiply(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Multiply:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Multiply:
        """Create an instance of Multiply from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Multiply.parse_obj(obj)

        _obj = Multiply.parse_obj({
