...
class IfObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IfObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IfObject:
        """Create an instance of IfObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IfObject.parse_obj(obj)

        _obj = IfObject.parse_obj({
