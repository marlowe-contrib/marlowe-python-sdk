...
class ModelAnd(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelAnd:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelAnd:
        """Create an instance of ModelAnd from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelAnd.parse_obj(obj)

        _obj = ModelAnd.parse_obj({
