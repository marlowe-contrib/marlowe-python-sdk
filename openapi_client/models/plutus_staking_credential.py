...
class PlutusStakingCredential(BaseModel):
    ...
    actual_instance: Optional[Union[PlutusStakingCredentialOneOf, PlutusStakingCredentialOneOf1]] = None
    one_of_schemas: List[str] = Literal["PlutusStakingCredentialOneOf", "PlutusStakingCredentialOneOf1"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PlutusStakingCredential.model_construct()
        error_messages = []
        match = 0
