...
class ListObjectPayoutHeaderResultsInner(BaseModel):
    ...
    """
    links: ListObjectPayoutHeaderResultsInnerLinks = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListObjectPayoutHeaderResultsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListObjectPayoutHeaderResultsInner:
        """Create an instance of ListObjectPayoutHeaderResultsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListObjectPayoutHeaderResultsInner.parse_obj(obj)

        _obj = ListObjectPayoutHeaderResultsInner.parse_obj({
