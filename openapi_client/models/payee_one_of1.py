...
class PayeeOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayeeOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayeeOneOf1:
        """Create an instance of PayeeOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayeeOneOf1.parse_obj(obj)

        _obj = PayeeOneOf1.parse_obj({
