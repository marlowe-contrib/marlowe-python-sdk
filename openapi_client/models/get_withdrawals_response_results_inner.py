...
class GetWithdrawalsResponseResultsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWithdrawalsResponseResultsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWithdrawalsResponseResultsInner:
        """Create an instance of GetWithdrawalsResponseResultsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWithdrawalsResponseResultsInner.parse_obj(obj)

        _obj = GetWithdrawalsResponseResultsInner.parse_obj({
