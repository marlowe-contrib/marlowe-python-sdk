...
class LesserObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LesserObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LesserObject:
        """Create an instance of LesserObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LesserObject.parse_obj(obj)

        _obj = LesserObject.parse_obj({
...
LesserObject.update_forward_refs()
