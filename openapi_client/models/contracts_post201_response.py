...
class ContractsPost201Response(BaseModel):
    """
    ContractsPost201Response
    """
    links: ContractsPost201ResponseLinks = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractsPost201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractsPost201Response:
        """Create an instance of ContractsPost201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractsPost201Response.parse_obj(obj)

        _obj = ContractsPost201Response.parse_obj({
            "links": ContractsPost201ResponseLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None,
