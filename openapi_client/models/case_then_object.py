...
class CaseThenObject(BaseModel):
    """
    CaseThenObject
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CaseThenObject:
        """Create an instance of CaseThenObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CaseThenObject:
        """Create an instance of CaseThenObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CaseThenObject.parse_obj(obj)

        _obj = CaseThenObject.parse_obj({
...
CaseThenObject.update_forward_refs()
