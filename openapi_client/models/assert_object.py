...
class AssertObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssertObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssertObject:
        """Create an instance of AssertObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssertObject.parse_obj(obj)

        _obj = AssertObject.parse_obj({
...
AssertObject.update_forward_refs()
