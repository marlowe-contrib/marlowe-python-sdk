...
class PayoutState(BaseModel):
    ...
    payout_validator_address: StrictStr = Field(..., alias="payoutValidatorAddress", description="A cardano address, in Bech32 format")
    role: AssetId = Field(...)
    ...
    __properties = ["assets", "contractId", "payoutId", "payoutValidatorAddress", "role", "status", "withdrawalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayoutState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayoutState:
        """Create an instance of PayoutState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayoutState.parse_obj(obj)

        _obj = PayoutState.parse_obj({
            ...
            "payout_validator_address": obj.get("payoutValidatorAddress"),
