...
class ContinuationInput(BaseModel):
    """
    Notify a contract to check a condition and provide the continuation of the contract  # noqa: E501
    """
    continuation_hash: StrictStr = Field(...)
    merkleized_continuation: Contract = Field(...)
    __properties = ["continuation_hash", "merkleized_continuation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContinuationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContinuationInput:
        """Create an instance of ContinuationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContinuationInput.parse_obj(obj)

        _obj = ContinuationInput.parse_obj({
