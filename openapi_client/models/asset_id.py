...
class AssetId(BaseModel):
    ...
    policy_id: Annotated[str, Field(strict=True)] = Field(description="The hex-encoded minting policy ID for a native Cardano token", alias="policyId")
    __properties: ClassVar[List[str]] = ["assetName", "policyId"]
