...
class LesserOrEqualObject(BaseModel):
    """
    LesserOrEqualObject
    """
    le_than: ValueObject = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LesserOrEqualObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LesserOrEqualObject:
        """Create an instance of LesserOrEqualObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LesserOrEqualObject.parse_obj(obj)

        _obj = LesserOrEqualObject.parse_obj({
...
LesserOrEqualObject.update_forward_refs()
