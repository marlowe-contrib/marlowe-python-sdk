...
class NegateObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NegateObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NegateObject:
        """Create an instance of NegateObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NegateObject.parse_obj(obj)

        _obj = NegateObject.parse_obj({
...
NegateObject.update_forward_refs()
