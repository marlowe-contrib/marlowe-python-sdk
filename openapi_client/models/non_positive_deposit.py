...
class NonPositiveDeposit(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NonPositiveDeposit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NonPositiveDeposit:
        """Create an instance of NonPositiveDeposit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NonPositiveDeposit.parse_obj(obj)

        _obj = NonPositiveDeposit.parse_obj({
