...
class PayToParty(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayToParty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayToParty:
        """Create an instance of PayToParty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayToParty.parse_obj(obj)

        _obj = PayToParty.parse_obj({
