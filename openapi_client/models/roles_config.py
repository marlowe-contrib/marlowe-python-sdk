...
class RolesConfig(BaseModel):
    ...
    """
    # data type: str
    oneof_schema_1_validator: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The hex-encoded minting policy ID for a native Cardano token")
    # data type: Dict[str, RoleTokenConfig]
    oneof_schema_2_validator: Optional[Dict[str, RoleTokenConfig]] = None
    actual_instance: Optional[Union[Dict[str, RoleTokenConfig], str]] = None
    one_of_schemas: List[str] = Literal["Dict[str, RoleTokenConfig]", "str"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = RolesConfig.model_construct()
        error_messages = []
        match = 0
