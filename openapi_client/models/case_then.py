...
class CaseThen(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CaseThen:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CaseThen:
        """Create an instance of CaseThen from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CaseThen.parse_obj(obj)

        _obj = CaseThen.parse_obj({
