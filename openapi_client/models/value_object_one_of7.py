...
class ValueObjectOneOf7(BaseModel):
    """
    ValueObjectOneOf7
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValueObjectOneOf7:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValueObjectOneOf7:
        """Create an instance of ValueObjectOneOf7 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValueObjectOneOf7.parse_obj(obj)

        _obj = ValueObjectOneOf7.parse_obj({
...
ValueObjectOneOf7.update_forward_refs()
