...
class PartialPayment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialPayment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialPayment:
        """Create an instance of PartialPayment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PartialPayment.parse_obj(obj)

        _obj = PartialPayment.parse_obj({
