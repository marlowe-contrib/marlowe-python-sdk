...
class MultiplyObject(BaseModel):
    """
    MultiplyObject
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MultiplyObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MultiplyObject:
        """Create an instance of MultiplyObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MultiplyObject.parse_obj(obj)

        _obj = MultiplyObject.parse_obj({
...
MultiplyObject.update_forward_refs()
