...
class ValueOneOf8(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "else": Value.from_dict(obj.get("else")) if obj.get("else") is not None else None,
            "if": Observation.from_dict(obj.get("if")) if obj.get("if") is not None else None,
...
ValueOneOf8.model_rebuild(raise_errors=False)
