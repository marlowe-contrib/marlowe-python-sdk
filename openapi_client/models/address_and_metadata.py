...
class AddressAndMetadata(BaseModel):
    """
    AddressAndMetadata
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressAndMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressAndMetadata:
        """Create an instance of AddressAndMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressAndMetadata.parse_obj(obj)

        _obj = AddressAndMetadata.parse_obj({
