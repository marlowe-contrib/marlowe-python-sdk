...
class MarloweState(BaseModel):
    ...
    """ # noqa: E501
    accounts: List[Annotated[List[MarloweStateAccountsInnerInner], Field(min_length=2, max_length=2)]]
    bound_values: List[Annotated[List[MarloweStateBoundValuesInnerInner], Field(min_length=2, max_length=2)]] = Field(alias="boundValues")
    choices: List[Annotated[List[MarloweStateChoicesInnerInner], Field(min_length=2, max_length=2)]]
    min_time: StrictInt = Field(alias="minTime")
    __properties: ClassVar[List[str]] = ["accounts", "boundValues", "choices", "minTime"]
