...
class ModelNot(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelNot:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelNot:
        """Create an instance of ModelNot from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelNot.parse_obj(obj)

        _obj = ModelNot.parse_obj({
