...
class ContractObjectOneOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractObjectOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractObjectOneOf:
        """Create an instance of ContractObjectOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractObjectOneOf.parse_obj(obj)

        _obj = ContractObjectOneOf.parse_obj({
...
ContractObjectOneOf.update_forward_refs()
