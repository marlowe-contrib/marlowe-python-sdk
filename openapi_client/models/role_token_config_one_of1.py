...
class RoleTokenConfigOneOf1(BaseModel):
    """
    ...
    def script_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ThreadRole', 'OpenRole'):
            raise ValueError("must be one of enum values ('ThreadRole', 'OpenRole')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleTokenConfigOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleTokenConfigOneOf1:
        """Create an instance of RoleTokenConfigOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleTokenConfigOneOf1.parse_obj(obj)

        _obj = RoleTokenConfigOneOf1.parse_obj({
