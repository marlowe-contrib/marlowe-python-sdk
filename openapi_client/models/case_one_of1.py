...
class CaseOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CaseOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CaseOneOf1:
        """Create an instance of CaseOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CaseOneOf1.parse_obj(obj)

        _obj = CaseOneOf1.parse_obj({
