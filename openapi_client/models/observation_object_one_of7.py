...
class ObservationObjectOneOf7(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObservationObjectOneOf7:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObservationObjectOneOf7:
        """Create an instance of ObservationObjectOneOf7 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObservationObjectOneOf7.parse_obj(obj)

        _obj = ObservationObjectOneOf7.parse_obj({
...
ObservationObjectOneOf7.update_forward_refs()
