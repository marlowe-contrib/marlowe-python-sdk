...
class ValueOneOf3(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValueOneOf3:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValueOneOf3:
        """Create an instance of ValueOneOf3 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValueOneOf3.parse_obj(obj)

        _obj = ValueOneOf3.parse_obj({
...
ValueOneOf3.update_forward_refs()
