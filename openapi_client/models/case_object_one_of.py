...
class CaseObjectOneOf(BaseModel):
    """
    CaseObjectOneOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CaseObjectOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CaseObjectOneOf:
        """Create an instance of CaseObjectOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CaseObjectOneOf.parse_obj(obj)

        _obj = CaseObjectOneOf.parse_obj({
...
CaseObjectOneOf.update_forward_refs()
