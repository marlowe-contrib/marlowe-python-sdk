...
class TransactionOutput(BaseModel):
    ...
    actual_instance: Optional[Union[TransactionOutputOneOf, TransactionOutputOneOf1]] = None
    one_of_schemas: List[str] = Literal["TransactionOutputOneOf", "TransactionOutputOneOf1"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = TransactionOutput.model_construct()
        error_messages = []
        match = 0
