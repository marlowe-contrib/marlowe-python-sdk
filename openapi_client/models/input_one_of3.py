...
class InputOneOf3(BaseModel):
    ...
    """ # noqa: E501
    continuation_hash: StrictStr
    input_from_party: Party
    into_account: Party
    merkleized_continuation: Contract
    of_token: Token
    that_deposits: StrictInt
    __properties: ClassVar[List[str]] = ["continuation_hash", "input_from_party", "into_account", "merkleized_continuation", "of_token", "that_deposits"]
