...
class Value(BaseModel):
    ...
    actual_instance: Optional[Union[ValueOneOf, ValueOneOf1, ValueOneOf2, ValueOneOf3, ValueOneOf4, ValueOneOf5, ValueOneOf6, ValueOneOf7, ValueOneOf8, int, str]] = None
    one_of_schemas: List[str] = Literal["ValueOneOf", "ValueOneOf1", "ValueOneOf2", "ValueOneOf3", "ValueOneOf4", "ValueOneOf5", "ValueOneOf6", "ValueOneOf7", "ValueOneOf8", "int", "str"]
