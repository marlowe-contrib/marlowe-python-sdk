...
class ObservationOneOf1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["either", "or"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "or": Observation.from_dict(obj.get("or")) if obj.get("or") is not None else None
        })
        return _obj

from openapi_client.models.observation import Observation
# TODO: Rewrite to not use raise_errors
ObservationOneOf1.model_rebuild(raise_errors=False)
