...
class ContractOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractOneOf1:
        """Create an instance of ContractOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractOneOf1.parse_obj(obj)

        _obj = ContractOneOf1.parse_obj({
            "var_else": Contract.from_dict(obj.get("else")) if obj.get("else") is not None else None,
...
ContractOneOf1.update_forward_refs()
