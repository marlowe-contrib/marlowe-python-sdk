...
class ActionOneOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActionOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActionOneOf1:
        """Create an instance of ActionOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActionOneOf1.parse_obj(obj)

        _obj = ActionOneOf1.parse_obj({
