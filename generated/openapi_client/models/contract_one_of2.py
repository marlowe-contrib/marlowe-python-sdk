...
class ContractOneOf2(BaseModel):
    """
    ...
    timeout_continuation: Contract = Field(...)
    when: conlist(Case) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractOneOf2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractOneOf2:
        """Create an instance of ContractOneOf2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractOneOf2.parse_obj(obj)

        _obj = ContractOneOf2.parse_obj({
            "timeout": obj.get("timeout"),
            "timeout_continuation": Contract.from_dict(obj.get("timeout_continuation")) if obj.get("timeout_continuation") is not None else None,
            "when": [Case.from_dict(_item) for _item in obj.get("when")] if obj.get("when") is not None else None
        })
        return _obj

from openapi_client.models.case import Case
from openapi_client.models.contract import Contract
ContractOneOf2.update_forward_refs()
