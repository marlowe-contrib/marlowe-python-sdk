...
class GetContractsResponseResultsInnerLinks(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetContractsResponseResultsInnerLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetContractsResponseResultsInnerLinks:
